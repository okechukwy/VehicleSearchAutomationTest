...
#TODO
#Scenario: Compare the input and output csv files
#	Given I have records in the output file
#	When I compare the content of the input and output files
#	Then they should match each other